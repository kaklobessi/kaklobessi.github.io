  ...
  <div style="margin-bottom:3rem;">
    ...
    <div style="display:flex; flex-direction:column; gap:0.5rem;">
      ...
      <details style="border-radius:6px; overflow:hidden; border:1px solid var(--bs-border-color);">
        ...
        <div style="padding:1.2rem 1.5rem; background:var(--bs-body-bg); line-height:1.8; font-size:0.93rem;">
      ...
      <details style="border-radius:6px; overflow:hidden; border:1px solid var(--bs-border-color);">
        ...
        <div style="padding:1.1rem 1.4rem; background:var(--bs-body-bg);">
      ...
      <details style="border-radius:6px; overflow:hidden; border:1px solid var(--bs-border-color);">
        ...
        <div style="padding:1.4rem; background:var(--bs-body-bg); display:flex; flex-direction:column; gap:2.5rem;">
