...
<div style="margin-top:2rem;">
  ...
  <div style="margin-bottom:3rem;">
    ...
    <p style="color:#333; font-size:0.93rem; margin-bottom:1.2rem; line-height:1.7;">
      A composite priority index combining census, satellite, and geospatial data to rank cantons and neighborhoods in Togo by vulnerability, supporting evidence-based allocation of social and infrastructure investments. A more comprehensive version of the index (v5) is currently in progress and will be available shortly.
    </p>
