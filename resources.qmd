...
<div style="margin-top:2rem;">
  ...
  <div style="margin-bottom:3rem;">
    ...
    <p style="color:#555; font-size:0.88rem; margin-bottom:0.8rem;">
    ...
    <div style="display:flex; flex-direction:column; gap:0.5rem;">
      ...
      <!-- Methodology -->
      <details style="border-radius:6px; overflow:hidden; border:1px solid #e0e6f0;">
        ...
        <div style="padding:1.2rem 1.5rem; line-height:1.8; font-size:0.93rem;">
      ...
      <details style="border-radius:6px; overflow:hidden; border:1px solid #e0e6f0;">
        ...
        <div style="padding:1.1rem 1.4rem;">
          <table style="width:100%; border-collapse:collapse; font-size:0.92rem;">
            ...
            <tbody>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Population & poverty</td><td style="padding:0.4rem 0.6rem; color:#555;">RGPH 2022, EHCVM <span style="color:#002366; font-size:0.8rem;">†</span></td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Canton boundaries</td><td style="padding:0.4rem 0.6rem; color:#555;">Shapefile canton <span style="color:#002366; font-size:0.8rem;">†</span></td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Nighttime lights</td><td style="padding:0.4rem 0.6rem; color:#555;">NASA VIIRS</td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Relative wealth</td><td style="padding:0.4rem 0.6rem; color:#555;">Meta RWI</td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Service accessibility</td><td style="padding:0.4rem 0.6rem; color:#555;">OpenStreetMap</td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Road network</td><td style="padding:0.4rem 0.6rem; color:#555;">OpenStreetMap</td></tr>
              <tr style="border-bottom:1px solid #e0e6f0;"><td style="padding:0.4rem 0.6rem;">Flood risk</td><td style="padding:0.4rem 0.6rem; color:#555;">GFD / FATHOM</td></tr>
              <tr><td style="padding:0.4rem 0.6rem;">Built-up density</td><td style="padding:0.4rem 0.6rem; color:#555;">GHSL</td></tr>
            </tbody>
          </table>
          <p style="margin-top:0.9rem; margin-bottom:0; font-size:0.82rem; color:#555;">
      ...
      <details style="border-radius:6px; overflow:hidden; border:1px solid #e0e6f0;">
        ...
        <div style="padding:1.4rem; display:flex; flex-direction:column; gap:2.5rem;">
          ...
          <div>
            ...
            <div style="display:flex; gap:1rem; flex-wrap:wrap;">
              <div style="flex:1; min-width:200px;">
                <img src="images/togo_lumieres_nocturnes_2025.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
              ...
              <div style="flex:1; min-width:200px;">
                <img src="images/lome_lumieres_nocturnes_2025.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
          ...
          <div>
            ...
            <div style="max-width:340px;">
              <img src="images/rwi_mean_map.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
          ...
          <div>
            ...
            <div style="display:flex; gap:1rem; flex-wrap:wrap;">
              <div style="flex:1; min-width:200px;">
                <img src="images/priority_v5_map.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
              ...
              <div style="flex:1; min-width:200px;">
                <img src="images/dagl_priority_v5_map.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
          ...
          <div>
            ...
            <img src="images/rwi_fgt0_quadrant_scatter_sans_lome.png" style="width:100%; border-radius:6px; border:1px solid #e0e6f0;">
